...
```{r}
# Run 7 bam example - TODO: use a median exmaple for indepth qc analysis
...
for (dir in dirs) {
  ...
  for (bamFile in bamFiles) {
    ...
    write.csv(readFrequencies(myPanel1), file = paste(sample_name, "_readFrequencies.csv", sep = ""))
    ...
    write.csv(getFeaturePanel(myPanel1), file = paste(sample_name, "_getFeaturePanel.csv", sep = ""))
